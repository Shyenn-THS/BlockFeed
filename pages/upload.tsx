...
const Upload = () => {
  ...
  const { createSale, getCurrentID, currentAccount } = useContext(
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      const url = `https://BlockFeed.infura-ipfs.io/ipfs/${added.path}`;
      ...
      <div className=" bg-white rounded-lg xl:h-full mb-8 flex gap-6 flex-wrap justify-center items-center p-14 pt-6">
        <div>
          ...
          <div className=" border-dashed rounded-xl border-4 border-gray-200 flex flex-col justify-center items-center  outline-none mt-10 w-[260px] h-[458px] p-10 cursor-pointer hover:border-red-300 hover:bg-gray-100">
            {progressFormatted ? (
              <p className="text-center text-xl text-green-400 font-semibold mt-4 w-[260px]">
                {progressFormatted}
              </p>
            ) : (
              <div>
                  ...
                  !video ? (
                    ...
                    <div>
                      ...
                      <p
                        ...
                        className="bg-[#F51997] text-center mt-8 rounded text-white text-md font-medium p-2 w-52 outline-none"
                      >
                        Upload file
                      </p>
                    </div>
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <div className="flex gap-6 mt-10">
            ...
            <button
              disabled={topic && price && caption ? false : true}
              onClick={handlePost}
              type="button"
